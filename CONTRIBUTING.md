...
The following is a set of guidelines for contributing to this repository, which is hosted in the [BPDC ACM Organization](https://github.com/acmbpdc) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
